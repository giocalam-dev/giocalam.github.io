...
**GiocaLAM** è una Progressive Web App (PWA) moderna, veloce e installabile, progettata per la gestione completa di 4 distinti tornei sportivi (Calcio, Pallavolo, Basket e Calcetto Balilla) organizzati da **Lista Autonoma Mente (LAM)**.
...
*   **🏟️ Gestione Multi-Sport**:
    ...
    *   **Basket**: Campionato a girone unico (5 squadre).
    *   **Calcetto Balilla**: Campionato a girone unico (6 squadre).
*   **📊 Classifiche Automatiche Intelligenti**: Calcolo automatico dei punti e dei criteri di spareggio (differenza reti/punti, gol fatti) in base al regolamento specifico di ogni sport:
    ...
    *   *Pallavolo/Balilla*: Vittoria netta (3 pt), Vittoria ai vantaggi (2 pt), Sconfitta ai vantaggi (1 pt), Sconfitta netta (0 pt). Pareggio non ammesso.
